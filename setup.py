...
setup_kwargs = {}
try:
    verstrline = read('liverfunction/_version.py')
...
setup(
    name='liverfunction',
    description='Analysis of liver function tests',
    url='https://github.com/matthiaskoenig/liverfunction',
    ...
    keywords='liver function test, physiological based models',
